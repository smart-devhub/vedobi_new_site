...
function BestSeller({ product, isUpsellProduct = false, parentUpsellId = "" }) {
  ...
  const bestSellingProducts = products?.filter(
    (product) => product?.best_sellers === "best_sellers"
  );
  ...
  // }, [dispatch]);
  // Filter Top Recommends Products From Products
  // const topRecommendedProducts = BestSellerproducts
