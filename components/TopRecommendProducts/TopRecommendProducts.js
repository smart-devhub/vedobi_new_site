...
function TopRecommendProducts({
  ...
  // Filter Top Recommends Products From Products
  const topRecommendedProducts = products.filter(
  ...
  return (
    <section className="top-recommends py-2 my-2 bg-white">
      <div className="container">
        ...
        <div className="product-grid">
          <div className="container">
            <div className="row">
              <Swiper {...settings}>
                {topRecommendedProducts.map((product, key) => {
                  return (
                    <div
...
export default React.memo(TopRecommendProducts);
